...
/**
 * Servlet implementation class QueAddServlet
 */
public class QueAddServlet extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			query.Questionadd(id, content, context1, context2, context3, context4);
		} catch (Exception e) {
